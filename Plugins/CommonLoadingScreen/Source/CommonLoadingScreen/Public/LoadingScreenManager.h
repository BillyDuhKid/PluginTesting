...
protected:
	// The base path for button widgets if an override is not provided.
	virtual const TCHAR* GetLoadingScreenPath() { return TEXT("/TAB_Game/UI/LoadingScreen/TAB_LoadingScreenWBP"); }
	TSubclassOf<UUserWidget> LoadingScreenWBPClass;
